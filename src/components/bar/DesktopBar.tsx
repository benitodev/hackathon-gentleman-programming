...
const DesktopBar = () => { 
  ...
  const [outlinedIcons, setOutlinedIcons] = React.useState<BottomAppBarProps>(INITIAL_STATE)
  
  return (
    <AppBar position="fixed" sx={{display:{md:'block', xs:'none'}, top:'0', left:'0', backgroundColor:'#2d97bc'}} >
      <Container maxWidth="xl">
        <Toolbar sx={{justifyContent:'space-around'}} disableGutters>
          ...
          >
            <Avatar src="/rick-and-morty-logo.webp" alt="logo" sx={{width: {md:'70px'}, height:{md:'70px'}}} />
          </Typography>
